...
public class StudentClient
{
	...
	{
		SearchSOAPClassProxy a = new SearchSOAPClassProxy();
		a.getEndpoint();
		//System.out.println("==========> Got End point" + a.getEndpoint());
		StudentData[] studentDataArray = a.getCollectionOfSearchStrings(this.getFirstName(), 
				this.getLastName(), this.getCity(), this.getState());
		studentList = Arrays.asList(studentDataArray);
	}
}
